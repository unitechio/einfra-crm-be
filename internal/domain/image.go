...
// ImageUsecase defines the business logic for image-related operations.
type ImageUsecase interface {
	UploadImage(ctx context.Context, userID string, fileHeader *multipart.FileHeader) (*Image, error)
}
